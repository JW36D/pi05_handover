...
# `smooth_overlap` is handled specially in RobotClient because it depends on
# the overlap position inside the chunk; the callable here is a safe fallback.
AGGREGATE_FUNCTIONS = {
    "weighted_average": lambda old, new: 0.3 * old + 0.7 * new,
    "latest_only": lambda old, new: new,
    "average": lambda old, new: 0.5 * old + 0.5 * new,
    "conservative": lambda old, new: 0.7 * old + 0.3 * new,
    "smooth_overlap": lambda old, new: new,
}
